...
- 2025-10-28: Auth UX — Login now detects the Supabase “Email not confirmed” response and surfaces a verification CTA that routes back into the OTP screen with stored signup details plus a clear reminder to finish confirmation. The Verify Email screen inherits the leave-confirmation modal (header/back/system exit) and shows a success notice that lets users jump to the Dashboard or return to Login after verifying.
